...
#if REF!=2
    //--------------------------------------------------------------------------------
    //---- Here starts the actual CUDA part
    //--------------------------------------------------------------------------------
...
*/
    ...
    cudaMemcpy(mC, mC_buf, sizeof(float)*nunits, cudaMemcpyDeviceToHost);
...
#endif // REF!=2
    //--------------------------------------------------------------------------------
    //----  Here ends the actual CUDA part
    //--------------------------------------------------------------------------------
#ifdef VERBOSE
#if REF==1
    float mCtot=0.0;
...
#endif
#if REF!=2
    std::cout << "CUDA execution time "<<(tstop-tstart)<<" ms\n";
} // nruns
#endif
#else
#if REF!=2
