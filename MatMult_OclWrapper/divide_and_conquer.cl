...
If we have 4K, for float, that means 1K elts or a 32x32. 
...
for (int kk = 0 ; kk < mWidth/sbh; kk++) {
    for (int sk=0;sk<sbh;sk++) {
        float A_ii_kk=A[ii*mWidth*sbh+kk*sbw+mWidth*si+sk];
        float B_kk_jj=B[kk*mWidth*sbh+jj*sbw+mWidth*sk+sj];
